...
(3) Storage Setup :- 
--> Attaching a determined storage volume example AWS Persistent Disk to the postgres VM to make sure data do retain on the machine even if the VM gets restart.
...
(1) Deploying flask Backend :- Using a Paas 
